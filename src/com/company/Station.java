...
public class Station {
     static ArrayList<String> line1=new ArrayList<>(Arrays.asList("Helwan","Ain Helwan","Helwan University",
    ...
    static ArrayList<String> line2=new ArrayList<>(Arrays.asList( "El-Mounib","Sakiat Mekky"," Omm El-Masryeen","Giza","Faisal","Cairo University "
   ...
   static ArrayList<String> line3=new ArrayList<>(Arrays.asList("Airport","Ahmed Galal","Adly Mansour","El Haykestep","Omar Ibn El-Khattab",
