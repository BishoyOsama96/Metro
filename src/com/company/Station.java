...
public class Station {
     static ArrayList<String> list1=new ArrayList<>(Arrays.asList("Helwan","Ain Helwan","Helwan University",
   ...
   static ArrayList<String> list3=new ArrayList<>(Arrays.asList("Airport","Ahmed Galal","Adly Mansour","El Haykestep","Omar Ibn El-Khattab",
